      ...
      <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
        <div className="max-w-md">
          ...
          <p className="text-2xl md:text-3xl font-light leading-normal">
            Désolé, nous n&rsquo;avons pas pu trouver cette page.{' '}
          </p>
          <p className="mb-8">
            Mais ne vous inquiétez pas, vous pouvez trouver bien d&rsquo;autres
            choses sur notre page d&rsquo;accueil.
          </p>
          <a href="/">
            <button
              className="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue "
              style={{
                background:
