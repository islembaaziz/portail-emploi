...
const NavBar = () => {
  const navLinks = [
    { href: '/', label: 'Home' },
    { href: 'about', label: 'About1' },
    { href: 'about', label: 'About2' },
    { href: 'about', label: 'About3' },
  ];
  return (
    <nav className="relative flex w-full flex-wrap items-center justify-between bg-zinc-50 py-2 shadow-dark-mild">
