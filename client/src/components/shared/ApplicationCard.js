...
const ApplicationCard = ({ applications }) => {
  ...
  return (
    <div key={applications.id} className="bg-zinc-100 hover:bg-slate-100 shadow-md rounded-lg p-6 m-4 w-full flex flex-col">
      ...
      <div className="flex justify-center">
        <div className="bg-teal-600 text-white w-1/3 uppercase font-bold rounded-xl p-2">
        {applications.status} 
        </div>
      </div>
    </div>
